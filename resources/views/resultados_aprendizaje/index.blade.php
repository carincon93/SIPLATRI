...
@section('content')
    <div class="container">
        <div class="d-flex flex-column flex-lg-row form-busqueda-programacion justify-content-between mb-5">
            ...
            @can('admin')
                <a href="{{ route('resultados_aprendizaje.create') }}" class="btn btn-sm btn-success">Crear resultado de
                    aprendizaje</a>
            @endcan
        </div>
                                ...
                                <div class="row m-0">
                                    <div class="col-md-10">
                                        ...
                                        <div class="text-black-50"><i
                                                class="fa fa-clock mr-2"></i>{{ $resultadoAprendizaje->horas }} h</div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="acciones">
                                            ...
                                            @can('admin')
                                                ...
                                                <button type="button" class="no-button"
                                                    @click="modalEliminar({{ $resultadoAprendizaje->id }})"
    ...
    <modal v-if="modal" @close="modal = false">
        <h3 slot="header" class="text-lowercase text-center">¿<span class="text-uppercase">E</span>stás seguro(a) que desea
            eliminar este resultado de aprendizaje?</h3>
